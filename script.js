...
$(document).ready(function () {
    ...
    const animationScript = ["Java Developer", "Java FullStack Developer", "Software Developer"];
  ...
  // EmailJS integration script start
  (function() {
    emailjs.init("RSGdwB-3yIrZqVfI9"); 
})();
...
document.getElementById('contact-form').addEventListener('submit', function(event) {
    ...
    emailjs.sendForm('service_ry5e8ip', 'template_dbrpazc', this)
        .then(function() {
...
// EmailJS integration script end
